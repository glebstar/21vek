                    ...
                    <div class="row-fluid" id="photos-here">
                        ...
                        @foreach($images as $image)
                            <div class="span3 my-img" data-image-id="{{ $image->id }}">
                                <a href="#" data-object-id="{{ $object->id }}" data-image-id="{{ $image->id }}" onclick="return deleteImage(this)"><img src="/photo/{{ $object->id }}/{{ $image->id }}.{{ $image->name }}" style="height: 100px;" /></a>
